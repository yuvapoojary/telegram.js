 ...
 * Source: Bot API 10.1 (June 11, 2026)
...
export interface AnswerPreCheckoutQueryParams {
   ...
   * with the checkout (e.g. "Sorry, somebody just bought the last of our amazing black T-shirts while you were
   * busy filling out your payment details. Please choose a different color or garment!"). Telegram will display
...
export interface AnswerShippingQueryParams {
  ...
  /**
   * Pass True if delivery to the specified address is possible and False if there are any problems (for example,
...
export interface GetChatAdministratorsParams {
  ...
  /**
   * Pass True to additionally receive all bots that are administrators of the chat. By default, bots other than
   * the current bot are omitted.
   */
  return_bots?: boolean;
}
...
export interface GetUpdatesParams {
   ...
   * update_id. The negative offset can be specified to retrieve updates starting from -offset update from the end
...
export interface PostStoryParams {
  ...
  /**
   * Period after which the story is moved to the archive, in seconds; must be one of 6 * 3600, 12 * 3600, 86400,
   * or 2 * 86400
   */
...
export interface PromoteChatMemberParams {
   ...
   * channel members, report spam messages, ignore slow mode, and send messages to the chat without paying Telegram
...
export interface RemoveBusinessAccountProfilePhotoParams {
   ...
   * account's privacy settings. After the main photo is removed, the previous profile photo (if present) becomes
   * the main photo.
   */
  is_public?: boolean;
}
...
export interface RestrictChatMemberParams {
   ...
   * can_send_photos, can_send_videos, can_send_video_notes, and can_send_voice_notes permissions; the
...
export interface SendMediaGroupParams {
   ...
   */
  media: T.InputMediaAudio[] | T.InputMediaDocument[] | T.InputMediaLivePhoto[] | T.InputMediaPhoto[] | T.InputMediaVideo[];
...
export interface SendPaidMediaParams {
  ...
  /**
   * Unique identifier for the target chat or username of the target bot, supergroup or channel in the format
   * @username. If the chat is a channel, all Telegram Star proceeds from this media will be credited to the chat's
...
export interface SendPhotoParams {
   ...
   * 10000 in total. Width and height ratio must be at most 20. More information on Sending Files:
   * https://core.telegram.org/bots/api#sending-files
   */
  photo: T.InputFile | string;
...
export interface SendPollParams {
  ...
  /**
   * Pass True, if voting is limited to users who have been members of the chat where the poll is being sent for
   * more than 24 hours; for channel chats only
   */
   ...
   */
  explanation_media?: T.InputPollMedia;
...
export interface SendStickerParams {
   ...
   * .TGS, or .WEBM sticker using multipart/form-data. More information on Sending Files:
   * https://core.telegram.org/bots/api#sending-files. Video and animated stickers can't be sent via an HTTP URL.
   */
...
export interface SetStickerSetThumbnailParams {
   ...
   * Telegram to get a file from the Internet, or upload a new one using multipart/form-data. More information on
   * Sending Files: https://core.telegram.org/bots/api#sending-files. Animated and video sticker set thumbnails
   * can't be uploaded via HTTP URL. If omitted, then the thumbnail is dropped and the first sticker is used as the
   * thumbnail.
   */
  thumbnail?: T.InputFile | string;
...
export interface ApiMethods {
   ...
   */
  answerChatJoinRequestQuery(params: AnswerChatJoinRequestQueryParams): Promise<boolean>;

  /**
   * Use this method to reply to a received guest message. On success, a SentGuestMessage object is returned.
   */
  answerGuestQuery(params: AnswerGuestQueryParams): Promise<T.SentGuestMessage>;
   ...
   * will send an Update with a shipping_query field to the bot. Use this method to reply to shipping queries. On
   ...
   */
  answerWebAppQuery(params: AnswerWebAppQueryParams): Promise<T.SentWebAppMessage>;
   ...
   * in the chat for this to work and must have the can_manage_topics administrator rights. Returns True on
   * success.
   */
   ...
   * giveaway winners messages, and invoice messages can't be copied. A quiz poll can be copied only if the value
   * of the field correct_option_id is known to the bot. The method is analogous to the method forwardMessage, but
   * the copied message doesn't have a link to the original message. Returns the MessageId of the sent message on
   * success.
   */
  copyMessage(params: CopyMessageParams): Promise<T.MessageId>;
   ...
   * messages can't be copied. A quiz poll can be copied only if the value of the field correct_option_id is known
   * to the bot. The method is analogous to the method forwardMessages, but the copied messages don't have a link
   * to the original message. Album grouping is kept for copied messages. On success, an array of MessageId of the
   * sent messages is returned.
   */
  copyMessages(params: CopyMessagesParams): Promise<T.MessageId[]>;
   ...
   */
  createChatInviteLink(params: CreateChatInviteLinkParams): Promise<T.ChatInviteLink>;

  /**
   * Use this method to create a subscription invite link for a channel chat. The bot must have the
   * can_invite_users administrator rights. The link can be edited using the method editChatSubscriptionInviteLink
   * or revoked using the method revokeChatInviteLink. Returns the new invite link as a ChatInviteLink object.
   */
  createChatSubscriptionInviteLink(params: CreateChatSubscriptionInviteLinkParams): Promise<T.ChatInviteLink>;
   ...
   * can_manage_topics administrator right. Returns information about the created topic as a ForumTopic object.
   */
  createForumTopic(params: CreateForumTopicParams): Promise<T.ForumTopic>;
   ...
   * or chat. The bot must have the 'can_delete_messages' administrator right in the chat. Returns True on success.
   */
   ...
   * delete messages sent by the bot itself, or the can_delete_all_messages business bot right to delete any
   ...
   * work and must have the can_delete_messages administrator rights. Returns True on success.
   */
   ...
   * can delete incoming messages in private chats. - Bots granted can_post_messages permissions can delete
   * outgoing messages in channels. - If the bot is an administrator of a group, it can delete any message there. -
   * If the bot has can_delete_messages administrator right in a supergroup or a channel, it can delete any message
   * there. - If the bot has can_manage_direct_messages administrator right in a channel, it can delete any message
   * in the corresponding direct messages chat. Returns True on success.
   */
   ...
   */
  editChatInviteLink(params: EditChatInviteLinkParams): Promise<T.ChatInviteLink>;
   ...
   */
  editChatSubscriptionInviteLink(params: EditChatSubscriptionInviteLinkParams): Promise<T.ChatInviteLink>;
   ...
   * edited Message is returned, otherwise True is returned. Note that business messages that were not sent by the
   * bot and do not contain an inline keyboard can only be edited within 48 hours from the time they were sent.
   */
  editMessageCaption(params?: EditMessageCaptionParams): Promise<T.Message | boolean>;

  /**
   * Use this method to edit a checklist on behalf of a connected business account. On success, the edited Message
   * is returned.
   */
  editMessageChecklist(params: EditMessageChecklistParams): Promise<T.Message>;

  /**
   * Use this method to edit live location messages. A location can be edited until its live_period expires or
   * editing is explicitly disabled by a call to stopMessageLiveLocation. On success, if the edited message is not
   * an inline message, the edited Message is returned, otherwise True is returned.
   */
  editMessageLiveLocation(params: EditMessageLiveLocationParams): Promise<T.Message | boolean>;
   ...
   * its file_id or specify a URL. On success, if the edited message is not an inline message, the edited Message
   * is returned, otherwise True is returned. Note that business messages that were not sent by the bot and do not
   * contain an inline keyboard can only be edited within 48 hours from the time they were sent.
   */
  editMessageMedia(params: EditMessageMediaParams): Promise<T.Message | boolean>;
   ...
   * sent by the bot and do not contain an inline keyboard can only be edited within 48 hours from the time they
   * were sent.
   */
  editMessageReplyMarkup(params?: EditMessageReplyMarkupParams): Promise<T.Message | boolean>;
   ...
   * were sent.
   */
  editMessageText(params?: EditMessageTextParams): Promise<T.Message | boolean>;
   ...
   */
  editStory(params: EditStoryParams): Promise<T.Story>;
   ...
   */
  forwardMessage(params: ForwardMessageParams): Promise<T.Message>;
   ...
   */
  forwardMessages(params: ForwardMessagesParams): Promise<T.MessageId[]>;
   ...
   */
  getBusinessAccountGifts(params: GetBusinessAccountGiftsParams): Promise<T.OwnedGifts>;
   ...
   */
  getBusinessAccountStarBalance(params: GetBusinessAccountStarBalanceParams): Promise<T.StarAmount>;
   ...
   */
  getBusinessConnection(params: GetBusinessConnectionParams): Promise<T.BusinessConnection>;

  /**
   * Use this method to get up-to-date information about the chat. Returns a ChatFullInfo object on success.
   */
  getChat(params: GetChatParams): Promise<T.ChatFullInfo>;

  /**
   * Use this method to get a list of administrators in a chat. Returns an Array of ChatMember objects.
   */
  getChatAdministrators(params: GetChatAdministratorsParams): Promise<T.ChatMember[]>;

  /**
   * Returns the gifts owned by a chat. Returns OwnedGifts on success.
   */
  getChatGifts(params: GetChatGiftsParams): Promise<T.OwnedGifts>;
   ...
   */
  getChatMember(params: GetChatMemberParams): Promise<T.ChatMember>;
   ...
   */
  getChatMenuButton(params?: GetChatMenuButtonParams): Promise<T.MenuButton>;

  /**
   * Use this method to get information about custom emoji stickers by their identifiers. Returns an Array of
   * Sticker objects.
   */
  getCustomEmojiStickers(params: GetCustomEmojiStickersParams): Promise<T.Sticker[]>;
   ...
   */
  getFile(params: GetFileParams): Promise<T.File>;
   ...
   */
  getGameHighScores(params: GetGameHighScoresParams): Promise<T.GameHighScore[]>;

  /**
   * Use this method to get the access settings of a managed bot. Returns a BotAccessSettings object on success.
   */
  getManagedBotAccessSettings(params: GetManagedBotAccessSettingsParams): Promise<T.BotAccessSettings>;
   ...
   */
  getMyCommands(params?: GetMyCommandsParams): Promise<T.BotCommand[]>;

  /**
   * Use this method to get the current default administrator rights of the bot. Returns ChatAdministratorRights on
   * success.
   */
  getMyDefaultAdministratorRights(params?: GetMyDefaultAdministratorRightsParams): Promise<T.ChatAdministratorRights>;

  /**
   * Use this method to get the current bot description for the given user language. Returns BotDescription on
   * success.
   */
  getMyDescription(params?: GetMyDescriptionParams): Promise<T.BotDescription>;

  /**
   * Use this method to get the current bot name for the given user language. Returns BotName on success.
   */
  getMyName(params?: GetMyNameParams): Promise<T.BotName>;
   ...
   */
  getMyShortDescription(params?: GetMyShortDescriptionParams): Promise<T.BotShortDescription>;
   ...
   * object.
   */
  getStarTransactions(params?: GetStarTransactionsParams): Promise<T.StarTransactions>;

  /**
   * Use this method to get a sticker set. On success, a StickerSet object is returned.
   */
  getStickerSet(params: GetStickerSetParams): Promise<T.StickerSet>;

  /**
   * Use this method to receive incoming updates using long polling (wiki). Returns an Array of Update objects.
   */
  getUpdates(params?: GetUpdatesParams): Promise<T.Update[]>;
   ...
   */
  getUserChatBoosts(params: GetUserChatBoostsParams): Promise<T.UserChatBoosts>;

  /**
   * Returns the gifts owned and hosted by a user. Returns OwnedGifts on success.
   */
  getUserGifts(params: GetUserGiftsParams): Promise<T.OwnedGifts>;
   ...
   */
  getUserPersonalChatMessages(params: GetUserPersonalChatMessagesParams): Promise<T.Message[]>;

  /**
   * Use this method to get a list of profile audios for a user. Returns a UserProfileAudios object.
   */
  getUserProfileAudios(params: GetUserProfileAudiosParams): Promise<T.UserProfileAudios>;

  /**
   * Use this method to get a list of profile pictures for a user. Returns a UserProfilePhotos object.
   */
  getUserProfilePhotos(params: GetUserProfilePhotosParams): Promise<T.UserProfilePhotos>;
   ...
   */
  postStory(params: PostStoryParams): Promise<T.Story>;
  ...
  /**
   * Marks incoming message as read on behalf of a business account. Requires the can_read_messages business bot
  ...
  /**
   * Removes the current profile photo of a managed business account. Requires the can_edit_profile_photo business
   ...
   * administrator in the chat for this to work and must have the can_manage_topics administrator rights. The topic
   * will be automatically unhidden if it was hidden. Returns True on success.
   */
   ...
   */
  repostStory(params: RepostStoryParams): Promise<T.Story>;
   ...
   */
  revokeChatInviteLink(params: RevokeChatInviteLinkParams): Promise<T.ChatInviteLink>;

  /**
   * Stores a message that can be sent by a user of a Mini App. Returns a PreparedInlineMessage object.
   */
  savePreparedInlineMessage(params: SavePreparedInlineMessageParams): Promise<T.PreparedInlineMessage>;

  /**
   * Stores a keyboard button that can be used by a user within a Mini App. Returns a PreparedKeyboardButton
   * object.
   */
  savePreparedKeyboardButton(params: SavePreparedKeyboardButtonParams): Promise<T.PreparedKeyboardButton>;
   ...
   * in the future.
   */
  sendAnimation(params: SendAnimationParams): Promise<T.Message>;
   ...
   * audio files of up to 50 MB in size, this limit may be changed in the future. For sending voice messages, use
   * the sendVoice method instead.
   */
  sendAudio(params: SendAudioParams): Promise<T.Message>;
   ...
   */
  sendChatJoinRequestWebApp(params: SendChatJoinRequestWebAppParams): Promise<boolean>;

  /**
   * Use this method to send a checklist on behalf of a connected business account. On success, the sent Message is
   * returned.
   */
  sendChecklist(params: SendChecklistParams): Promise<T.Message>;

  /**
   * Use this method to send phone contacts. On success, the sent Message is returned.
   */
  sendContact(params: SendContactParams): Promise<T.Message>;

  /**
   * Use this method to send an animated emoji that will display a random value. On success, the sent Message is
   * returned.
   */
  sendDice(params: SendDiceParams): Promise<T.Message>;
   ...
   */
  sendDocument(params: SendDocumentParams): Promise<T.Message>;

  /**
   * Use this method to send a game. On success, the sent Message is returned.
   */
  sendGame(params: SendGameParams): Promise<T.Message>;
   ...
   */
  sendInvoice(params: SendInvoiceParams): Promise<T.Message>;

  /**
   * Use this method to send live photos. On success, the sent Message is returned.
   */
  sendLivePhoto(params: SendLivePhotoParams): Promise<T.Message>;

  /**
   * Use this method to send point on the map. On success, the sent Message is returned.
   */
  sendLocation(params: SendLocationParams): Promise<T.Message>;
   ...
   */
  sendMediaGroup(params: SendMediaGroupParams): Promise<T.Message[]>;

  /**
   * Use this method to send text messages. On success, the sent Message is returned.
   */
  sendMessage(params: SendMessageParams): Promise<T.Message>;
   ...
   * call sendMessage with the complete message to persist it in the user's chat. Returns True on success.
   */
   ...
   */
  sendPaidMedia(params: SendPaidMediaParams): Promise<T.Message>;

  /**
   * Use this method to send photos. On success, the sent Message is returned.
   */
  sendPhoto(params: SendPhotoParams): Promise<T.Message>;
   ...
   */
  sendRichMessage(params: SendRichMessageParams): Promise<T.Message>;
   ...
   */
  sendRichMessageDraft(params: SendRichMessageDraftParams): Promise<boolean>;

  /**
   * Use this method to send static .WEBP, animated .TGS, or video .WEBM stickers. On success, the sent Message is
   * returned.
   */
  sendSticker(params: SendStickerParams): Promise<T.Message>;

  /**
   * Use this method to send information about a venue. On success, the sent Message is returned.
   */
  sendVenue(params: SendVenueParams): Promise<T.Message>;
   ...
   */
  sendVideo(params: SendVideoParams): Promise<T.Message>;
   ...
   */
  sendVideoNote(params: SendVideoNoteParams): Promise<T.Message>;
   ...
   * format (other formats may be sent as Audio or Document). On success, the sent Message is returned. Bots can
   * currently send voice messages of up to 50 MB in size, this limit may be changed in the future.
   */
  sendVoice(params: SendVoiceParams): Promise<T.Message>;
   ...
   * in the chat for this to work and must have the can_manage_tags administrator right. Returns True on success.
   */
   ...
   * or a supergroup for this to work and must have the can_restrict_members administrator rights. Returns True on
   * success.
   */
   ...
   */
  setGameScore(params: SetGameScoreParams): Promise<T.Message | boolean>;
   ...
   * submitted document is blurry, a scan shows evidence of tampering, etc. Supply some details in the error
   ...
   * Update. In case of an unsuccessful request (a request with response HTTP status code different from 2XY), we
   * will repeat the request and give up after a reasonable amount of attempts. Returns True on success. If you'd
   * like to make sure that the webhook was set by you, you can specify secret data in the parameter secret_token.
   * If specified, the request will contain a header "X-Telegram-Bot-Api-Secret-Token" with the secret token as
   * content.
   */
   ...
   */
  stopMessageLiveLocation(params?: StopMessageLiveLocationParams): Promise<T.Message | boolean>;

  /**
   * Use this method to stop a poll which was sent by the bot. On success, the stopped Poll is returned.
   */
  stopPoll(params: StopPollParams): Promise<T.Poll>;
   ...
   * you don't want this, use the parameter only_if_banned. Returns True on success.
   */
   ...
   * chat with a user. In the case of a supergroup chat the bot must be an administrator in the chat for this to
   * work and must have the can_pin_messages administrator right in the supergroup. Returns True on success.
   */
   ...
   * right. Additionally requires the can_transfer_stars business bot right if the upgrade is paid. Returns True on
   * success.
   */
   ...
   */
  uploadStickerFile(params: UploadStickerFileParams): Promise<T.File>;
...
export const METHOD_FILE_FIELDS: Readonly<Record<string, readonly string[]>> = {
  "sendAnimation": [
    "animation",
    "thumbnail"
  ],
