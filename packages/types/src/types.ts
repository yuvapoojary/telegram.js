...
/**
 * This object describes the type of a background. Currently, it can be one of - BackgroundTypeFill -
 ...
 * supported: - BotCommandScopeDefault - BotCommandScopeAllPrivateChats - BotCommandScopeAllGroupChats -
...
export interface BusinessBotRights {
  /**
   * Optional. True, if the bot can send and edit messages in the private chats that had incoming messages in the
   * last 24 hours
   */
  can_reply?: boolean;
  ...
  /**
   * Optional. True, if the bot can transfer Telegram Stars received by the business account to its own account, or
...
export interface ChatAdministratorRights {
  ...
  /**
   * Optional. True, if the administrator can manage direct messages of the channel and decline suggested posts;
   * for channels only
   */
...
export interface ChatJoinRequest {
  ...
  /**
   * Optional. Identifier of the join request query; for bots assigned to process join request only. If present,
   * then the bot must call sendChatJoinRequestWebApp or directly call answerChatJoinRequestQuery within 10
   * seconds.
   */
  query_id?: string;
}
 ...
 * are supported: - ChatMemberOwner - ChatMemberAdministrator - ChatMemberMember - ChatMemberRestricted -
...
export interface EncryptedPassportElement {
   ...
   * requested for "passport", "driver_license", "identity_card" and "internal_passport". The file can be decrypted
...
export interface ForumTopic {
  ...
  /**
   * Optional. True, if the name of the topic wasn't specified explicitly by its creator and likely needs to be
   * changed by the bot
   */
...
export interface GiftInfo {
  ...
  /**
   * Optional. True, if the sender and gift text are shown only to the gift receiver; otherwise, everyone will be
   * able to see them
   */
  is_private?: boolean;
...
export interface GiveawayWinners {
  ...
  /**
   * Optional. The number of Telegram Stars that were split between giveaway winners; for Telegram Star giveaways
   * only
   */
  prize_star_count?: number;
...
export interface InlineKeyboardButton {
   ...
   * in private chats between a user and the bot. Not supported for messages sent on behalf of a business account.
   */
  web_app?: WebAppInfo;
   ...
   * current chat's input field. May be empty, in which case only the bot's username will be inserted. This offers
   * a quick way for the user to open your bot in inline mode in the same chat - good for selecting something from
   * multiple options. Not supported in channels and for messages sent in channel direct messages chats and on
   * behalf of a business account.
   */
   ...
   * with a Telegram Star icon. NOTE: This type of button must always be the first button in the first row and can
...
export interface InlineQuery {
   ...
   * known for requests sent from official clients and most third-party clients, unless the request was sent from a
   * secret chat.
   */
  chat_type?: string;
 ...
 * InlineQueryResultArticle - InlineQueryResultAudio - InlineQueryResultContact - InlineQueryResultGame -
 * InlineQueryResultDocument - InlineQueryResultGif - InlineQueryResultLocation - InlineQueryResultMpeg4Gif -
 * InlineQueryResultPhoto - InlineQueryResultVenue - InlineQueryResultVideo - InlineQueryResultVoice Note: All
 * URLs passed in inline query results will be available to end users and therefore must be assumed to be public.
 */
 ...
 * the user with an optional caption. Alternatively, you can use input_message_content to send a message with the
 ...
 */
export type InputFile = Blob | Buffer | NodeJS.ReadableStream | { name: string; data: Blob | Buffer | NodeJS.ReadableStream };
...
export interface InputMediaLivePhoto {
   ...
   * name. More information on Sending Files: https://core.telegram.org/bots/api#sending-files. Sending live photos
 ...
 * currently support the following types: - InputTextMessageContent - InputRichMessageContent -
...
/**
 * This object represents the content of a poll option to be sent. It should be one of - InputMediaAnimation -
 * InputMediaLink - InputMediaLivePhoto - InputMediaLocation - InputMediaPhoto - InputMediaSticker -
...
/**
 * This object describes a profile photo to set. Currently, it can be one of - InputProfilePhotoStatic -
...
export interface InputRichMessage {
  /**
   * Optional. Content of the rich message to send described using HTML formatting. See rich message formatting
...
export interface InputSticker {
   ...
   * be uploaded via HTTP URL. More information on Sending Files: https://core.telegram.org/bots/api#sending-files
   */
  sticker: string;
...
/**
 * This object describes the content of a story to post. Currently, it can be one of - InputStoryContentPhoto -
...
export interface InputStoryContentVideo {
  ...
  /**
   * Optional. Timestamp in seconds of the frame that will be used as the static cover for the story. Defaults to
   * 0.0.
   */
 ...
 * icon_custom_emoji_id, and style must be used to specify the type of the button. For simple text buttons,
...
/**
 * This object describes a message that can be inaccessible to the bot. It can be one of - Message -
 * InaccessibleMessage
 */
 ...
 * MenuButtonWebApp - MenuButtonDefault If a menu button other than MenuButtonDefault is set for a private chat,
...
export interface Message {
  ...
  /**
   * Optional. Unique identifier of a message thread or forum topic to which the message belongs; for supergroups
  ...
  /**
   * Optional. Sender of the message; may be empty for messages sent to channels. For backward compatibility, if
  ...
  /**
   * Optional. Message is a live photo, information about the live photo. For backward compatibility, when this
  ...
  /**
   * Optional. Service message: the price for paid messages in the corresponding direct messages chat of a channel
   * has changed
   */
...
/**
 * This object describes the origin of a message. It can be one of - MessageOriginUser - MessageOriginHiddenUser
...
export interface OwnedGiftRegular {
  ...
  /**
   * Optional. Number of Telegram Stars that can be claimed by the receiver instead of the gift; omitted if the
...
/**
 * This object describes paid media. Currently, it can be one of - PaidMediaLivePhoto - PaidMediaPhoto -
 * PaidMediaPreview - PaidMediaVideo
 */
 ...
 * by the user. It should be one of: - PassportElementErrorDataField - PassportElementErrorFrontSide -
...
export interface Poll {
   ...
   * vote in the poll. The country code "FT" is used for users with anonymous numbers. If omitted, then users from
...
/**
 * This object describes the type of a reaction. Currently, it can be one of - ReactionTypeEmoji -
 ...
 * button (see ReplyKeyboardMarkup). Not supported in channels and for messages sent on behalf of a business
 * account.
 */
...
export interface ReplyParameters {
   ...
   * of the bot, supergroup or channel in the format @username. Not supported for messages sent on behalf of a
   ...
   * spoiler, custom_emoji, and date_time entities. The message will fail to send if the quote isn't found in the
   * original message.
   */
  quote?: string;
 ...
 * RichBlockParagraph - RichBlockSectionHeading - RichBlockPreformatted - RichBlockFooter - RichBlockDivider -
 ...
 * https://t.me/addemoji/AIActions for examples of custom emoji, which are recommended for usage in the block.
 */
 ...
 * RichText, or any of the following types: - RichTextBold - RichTextItalic - RichTextUnderline -
...
export interface StarAmount {
  ...
  /**
   * Optional. The number of 1/1000000000 shares of Telegram Stars; from -999999999 to 999999999; can be negative
 ...
 * StoryAreaTypeSuggestedReaction - StoryAreaTypeLink - StoryAreaTypeWeather - StoryAreaTypeUniqueGift
 */
...
export interface SuggestedPostApprovalFailed {
  /**
   * Optional. Message containing the suggested post whose approval has failed. Note that the Message object in
   * this field will not contain the reply_to_message field even if it itself is a reply.
   */
...
export interface SuggestedPostApproved {
  /**
   * Optional. Message containing the suggested post. Note that the Message object in this field will not contain
...
export interface SuggestedPostPaid {
  ...
  /**
   * Optional. The amount of the currency that was received by the channel in nanograms; for payments in TON grams
   * only
   */
  amount?: number;
 ...
 * can be one of - TransactionPartnerUser - TransactionPartnerChat - TransactionPartnerAffiliateProgram -
...
export interface TransactionPartnerUser {
  ...
  /**
   * Optional. Information about the affiliate that received a commission via this transaction. Can be available
...
/**
 * This object represents an incoming update. At most one of the optional fields can be present in any given
 * update.
 */
export interface Update {
  ...
  /**
   * Optional. New guest message. The bot can use the field Message.guest_query_id and the method answerGuestQuery
